...
twoway line avg_cases1 week, lpattern(dash) lcolor(gray) || line cases_lagged`germany_id' week, ytitle("COVID-19 case rates") legend(order(1 "EU+ Mean" 2 "Germany")) lpattern(solid) lcolor(black) xline(22, lstyle(foreground) lpattern(solid) lcolor(green)) xline(34, lstyle(foreground) lpattern(solid) lcolor(red))
...
// save graph of synthetic Germany generated by the synth function
...
twoway line cases_lagged`germany_id' week, lpattern(solid) lcolor(black) lwidth(thick) || line cases_lagged16 week, lpattern(dash) lcolor(blue) || line cases_lagged1 week, lpattern(dash) lcolor(red) || line cases_lagged9 week, lpattern(dash) lcolor(emerald) || line cases_lagged10 week, lpattern(dash) lcolor(gold) || line cases_lagged20 week, lpattern(dash) lcolor(brown) ytitle("COVID-19 case rates") legend(order(1 "Germany" 2 "Italy" 3 "Austria" 4 "Finland" 5 "France" 6 "Malta")) xline(22, lstyle(foreground) lpattern(solid) lcolor(green)) xline(34, lstyle(foreground) lpattern(solid) lcolor(red))
...
local call `call' line treatment_effect`germany_id' week, lpattern(solid)  lcolor(black) lwidth(thick) xline(22, lstyle(foreground) lpattern(solid) lcolor(green)) xline(34, lstyle(foreground) lpattern(dash) lcolor(red)) yline(0, lstyle(foreground) lpattern(solid) lcolor(gs8))
...
graph hbar MSErat, over(country, sort(1) label(labsize(vsmall)))
...
line treatment_effect`germany_id' week, lpattern(solid)  lcolor(black) xline(22, lstyle(foreground) lpattern(solid) lcolor(green)) xline(34, lstyle(foreground) lpattern(dash) lcolor(red)) yline(0, lstyle(foreground) lpattern(solid) lcolor(gs8))
...
foreach cntry in "Austria" "Belgium" "Bulgaria" "Croatia" "Cyprus" "Czechia" "Denmark" "Estonia" "Finland" "France" "Greece" "Hungary" "Iceland" "Ireland" "Italy" "Latvia" "Liechtenstein" "Lithuania" "Malta" "Netherlands" "Norway" "Poland" "Portugal" "Romania" "Slovakia" "Slovenia" "Spain" "Sweden" "Switzerland" "Mandates" "Neighbors" {
	...
	local call `call' line treatment_effect`germany_id' week, lpattern(solid)  lcolor(black) lwidth(thick) xline(22, lstyle(foreground) lpattern(solid) lcolor(green)) xline(34, lstyle(foreground) lpattern(solid) lcolor(red)) yline(0, lstyle(foreground) lpattern(solid) lcolor(gs8))
...
local call `call' line residual_Germany week, lpattern(dash)  lcolor(black) lwidth(thick) xline(22, lstyle(foreground) lpattern(solid) lcolor(green)) xline(34, lstyle(foreground) lpattern(solid) lcolor(red)) yline(0, lstyle(foreground) lpattern(solid) lcolor(gs8))
...
// save graph of synthetic versus actual lagged Covid-19 cases in Malta, generated by synth function
...
local call `call' line treatment_effect`malta_id' week, lpattern(solid)  lcolor(black) lwidth(thick) xline(39, lstyle(foreground) lpattern(solid) lcolor(green)) yline(0, lstyle(foreground) lpattern(solid) lcolor(gs8))
twoway `call'
...
line treatment_effect19 week, lpattern(solid)  lcolor(black) xline(39, lstyle(foreground) lpattern(solid) lcolor(green)) yline(0, lstyle(foreground) lpattern(solid) lcolor(gs8))
